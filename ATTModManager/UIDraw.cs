...
namespace ATTTModManagerNet
{
    ...
    public static partial class Extensions
    {
        ...
        /// </summary>
        public static void Draw<T>(this T instance, ATTTModManager.ModEntry mod) where T : class, IDrawable, new()
        {
            ATTTModManager.UI.DrawFields(ref instance, mod, DrawFieldMask.OnlyDrawAttr, instance.OnChange);
        }
    }
}
